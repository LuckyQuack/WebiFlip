...
const formatBoardDate = (createdAt: string): string => {
...
interface GifBoardGridProps {
  posts: BoardPost[];
  onSelectPost: (post: BoardPost) => void;
}

const GifBoardGrid = ({ posts, onSelectPost }: GifBoardGridProps) => {
  return (
    <div className="board-grid">
      {posts.map((post) => (
        <button key={post.id} type="button" className="board-tile" onClick={() => onSelectPost(post)}>
